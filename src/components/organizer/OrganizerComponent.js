...
class OrganizerComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        if (id === "profile") {
            this.setState({organizer: this.props.organizer, ownProfile: true})
        } else {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if ((prevState.organizer._id !== this.props.organizer._id || prevState.organizer._id !== this.state.organizer._id) && this._isMounted) {
            const pathParts = window.location.pathname.split('/');
            const id = pathParts.pop() || pathParts.pop();
            if (id === "profile") {
                this.setState({organizer: this.props.organizer, ownProfile: true})
